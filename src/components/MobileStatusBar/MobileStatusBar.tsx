...
function IosSignalIcon({ sx, ...rest }: { sx?: object; [k: string]: unknown }) {
  return (
    <Box
      component="svg"
      width={18}
...
function IosWifiIcon({ sx, ...rest }: { sx?: object; [k: string]: unknown }) {
  return (
    <Box
      component="svg"
      width={17}
...
function IosBatteryIcon({ sx, ...rest }: { sx?: object; [k: string]: unknown }) {
  return (
    <Box
      component="svg"
      width={28}
